...
<?php
    ...
    $de = $_POST['description'];
           ...
           if($qu=='' || $se=='' || $au=='' || $em=='' || $de==''){
               echo "<script>alert('Por favor, insira todos os campos')</script>";
           }
           else{
...
$date_time = date("d-m-Y (D) H:i:s", $timestamp);
           ...
           $insert_query = "insira no fórum (pergunta, descrição, autor, e-mail, tópico, hora) valores ('$qu','$de','$au','$em','$se','$date_time')";

$res=mysqli_query($con, $insert_query);
               
               echo "<script>alert('Seu fórum foi adicionado com sucesso, visite a página inicial para ver as alterações')</script>";
